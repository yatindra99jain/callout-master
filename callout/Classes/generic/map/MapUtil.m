                                     ...
                                     number:(const int) number 
{
    ...
    for(int i=0; i < number; i++) {
        ...
        content.iconURL = [[NSBundle mainBundle] URLForResource:@"commentactive_discuss_jmu" withExtension:@"png"];
        content.calloutView = [MyCalloutView class];
        content.coordinate = coord;
        content.values = [NSDictionary dictionaryWithObjectsAndKeys:@"test!",@"title",@"HellloooFriends",@"subtitle",@"HellloooFriends",@"subtitle1",nil];
...
//        content.values = [NSDictionary dictionaryWithObjectsAndKeys:@"hiiii!",@"title",@"HellloooFriends",@"subtitle", nil];
//        Annotation *anno = [[Annotation alloc] initWithContent:content];
//        
//		[randomAnnotations addObject:anno];
//		[anno release];
